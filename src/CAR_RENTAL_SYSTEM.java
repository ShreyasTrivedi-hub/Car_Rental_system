// CAR RENTAL SYSTEM -> JAVA OOPS PROJECTS

/* FEATURES -> 1. RENT A CAR
               2. GET CONFIRMATION SLIP
               3. USING JAVA OOPS CONCEPTS ONLY
               4. MENTIONED IN RESUME
   LEARNINGS -> ✅ Designing a Car Rental System using OOP principles.
...
class CarRentalSystem {
    ...
    public static void main(String[] args) {
        ...
        Car car1 = new Car("C001", "Toyota", "Vellfire", 60.0); // Different base price per day for each car
        Car car2 = new Car("C002", "Honda", "Elevate", 70.0);
        Car car3 = new Car("C003", "Mahindra", "Thar", 150.0);
        Car car4 = new Car("C004", "Mahindra", "XUV 700", 200.0);
        Car car5 = new Car("C005", "TATA", "HARRIER", 250.0);
